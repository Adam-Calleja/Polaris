...
MAX_BATCH_PREFILL_TOKENS=${MAX_BATCH_PREFILL_TOKENS:-65536}
MAX_BATCH_TOTAL_TOKENS=${MAX_BATCH_TOTAL_TOKENS:-131072}
VALIDATION_WORKERS=${VALIDATION_WORKERS:-2}
WAITING_SERVED_RATIO=${WAITING_SERVED_RATIO:-0.3}
