...
VOLUME=${VOLUME:-/mnt/data/polaris/test}
...
HF_CACHE_DIR=${HF_CACHE_DIR:-"${VOLUME}/hf-cache"}
VLLM_HOME_DIR=${VLLM_HOME_DIR:-"${VOLUME}/vllm-home"}
RECIPE_CACHE_BASE_DIR=${RECIPE_CACHE_BASE_DIR:-"${VOLUME}/recipe-cache"}
RECIPE_CACHE_DIR_HOST="${RECIPE_CACHE_BASE_DIR}/${MODEL_SAFE}/tag-${TAG_SAFE}/tp-${TENSOR_PARALLEL}/len-${MAX_MODEL_LEN}/seqs-${MAX_NUM_SEQS}/block-${BLOCK_SIZE}"
